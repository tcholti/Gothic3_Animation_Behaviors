...
Current gate: **generic equipped Sprint diagnostic causal probe — GOBLIN CAUSAL PASS + PROTECTED SENTINELS COMPLETE/PASS / BROADER FIXTURES NEXT**. Phase 4 non-weapon regression is temporarily held.
