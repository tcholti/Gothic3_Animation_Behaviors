...
**Status:** CLOSED / CLEANUP + NEUTRAL-BASELINE PASS — EV-350  
**Opened:** 2026-09-20  
...
EV-350 closed the cleanup.

Local result:
- both twins built successfully;
- diagnostic deployment PASS;
- sole live collision DLL = `Script_FrameCollisionTest.dll`;
- built/live SHA256 = `C33046D1AE139B5D905CF5E1004F725F07A5FE8CAC3A9705F11691497D7CD17D`;
- startup / hook installation / unload clean;
- optional frame-3 Gargoyle control returned to the old one-shot baseline;
- generic `CORE ONDAMAGE` observation remained;
- retired raw8 window/post-attempt records remained absent.

No permanent collision behavior was changed by this retirement.
