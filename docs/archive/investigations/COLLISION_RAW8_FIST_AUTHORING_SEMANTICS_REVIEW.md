...
**Status:** CLOSED — DESIGN/CAUSAL MODEL RESOLVED AT EV-353; PRODUCTION ARCHITECTURE PROMOTED  
**Opened:** 2026-09-20  
...
EV-353 closed the persistent-opportunity causal question. Current permanent design is owned by `docs/COLLISION_RAW8_PRODUCTION_ARCHITECTURE.md`; implementation is tracked separately under `docs/work/active/`. This archived review is historical reasoning/provenance, not current architecture.
