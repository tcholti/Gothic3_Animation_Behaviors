...
## Current permanent raw55 behavior
...
true Power first/second:
  current POWER + explicit SP1 or SP2
  first also requires earlyOpeningSuppressed

Sprint-origin first:
  current SPRINT + explicit SP1 or SP2 + earlyOpeningSuppressed
