...
void OpenLog()
{
    ...
    std::fprintf(g_pLog, "STEP B6 HIT STARTRECOVER / STOP / REPLACEMENT STACK PROBE: player PrimaryFirst outgoing attack-Hit StartRecover BEGIN, StopMotion, or direct replacement stack; diagnostic-only.\n");
